...
\begin{thm}
    Let $ K $ be a compact connected Lie group. Then there exists a complex Lie group $ K_{\C} $ and a Lie group homomorphism $ f : K \to K_{\C} $ such that \begin{enumerate}
        ...
        \item $ K_{C} $ is the complexification of $ K $.
    \end{enumerate}
\end{thm}
...
\begin{lemma}[Schur's lemma]
    Suppose that $ G $ is a compact Lie group. Let $ V_{0}, V_{1} $ be a finite dimensional irreducible representation over $\C $. Then any $ G $-homomorphism $ \psi : V_{0} \to V_{1} $ is either $ 0 $ or an isomorphism. Moreover, any $ G $-homomorphism $ V_{0} \to V_{0} $ is a scalar multiple of the idenity.
\end{lemma}
\begin{proof}
